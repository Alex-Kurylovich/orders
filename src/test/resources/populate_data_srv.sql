...
INSERT INTO customer (FIRST_NAME, LAST_NAME, EMAIL, PHONE, STREET, CITY, PROVINCE, ZIP_CODE)
VALUES ('Jennifer ', 'Johnson', 'customer1@gmail.com', '416-749-6668', '1432 Islington Ave', 'Toronto', 'Ontario', 'M9V2X5'),
       ('Natalie ', 'Robinson', 'customer2@gmail.com', '613-325-5624', '1901 Bank St', 'Ottawa', 'Ontario', 'K1H7Z1'),
       ('John ', 'Ferguson', 'customer3@gmail.com', '250-654-5431', '3449 Burdett Avenue', 'Sidney', 'British Columbia', 'V8L1X3'),
       ('Michael ', 'Hensley', 'customer4@gmail.com', '519-291-8453', '2783 9th Avenue', 'Listowel', 'Ontario', 'N4W2H8');
